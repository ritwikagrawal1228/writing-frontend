            ...
            <strong>
              <span style={{ fontSize: 15 }}>
                <span data-custom-class="subtitle">
                  Last updated <bdt className="question">March 11, 2023</bdt>
                </span>
              </span>
            </strong>
          </span>
            ...
            <span style={{ fontSize: 15, color: 'rgb(89, 89, 89)' }}>
              <span style={{ fontSize: 15, color: 'rgb(89, 89, 89)' }}>
                <span data-custom-class="body_text">
                  ...
                  <bdt className="question">
                    <a
                      href="https://ielts-writing-helper.com"
                      target="_blank"
                      data-custom-class="link"
                    >
                      https://ielts-writing-helper.com
                    </a>
                  </bdt>
                  <span style={{ fontSize: 15 }}>
                    <span style={{ color: 'rgb(89, 89, 89)' }}>
          ...
          <div style={{ lineHeight: '1.5' }}>
            <span style={{ fontSize: 15 }}>
              <span data-custom-class="body_text">
                ...
                request form available <bdt className="block-component" />
              </span>
            </span>
            <a
              data-custom-class="link"
              href="https://app.termly.io/notify/9b1b3db5-1020-4e0d-add7-ad8b847a1a32"
                  ...
                  <span style={{ fontSize: 15, color: 'rgb(89, 89, 89)' }}>
                    <span style={{ fontSize: 15, color: 'rgb(89, 89, 89)' }}>
                      <span data-custom-class="body_text">
                        ...
                        <bdt className="question">
                          <a
                            href="https://squareup.com/ca/en/legal/general/privacy"
                            target="_blank"
                            data-custom-class="link"
                          >
                            https://squareup.com/ca/en/legal/general/privacy
                          </a>
                        </bdt>
                        <span
                          style={{ fontSize: 15, color: 'rgb(89, 89, 89)' }}
            ...
            <span style={{ fontSize: 15, color: 'rgb(89, 89, 89)' }}>
              <span style={{ fontSize: 15, color: 'rgb(89, 89, 89)' }}>
                <span data-custom-class="body_text">
                  ...
                  intent data (or user <bdt className="block-component" />
                  behavior
                  ...
                  <span style={{ color: 'rgb(89, 89, 89)' }}>
                    <span style={{ fontSize: 15 }}>
                      <span data-custom-class="body_text">
                        ...
                        your social media account (e.g.
                        <bdt className="block-component" />,
                        <bdt className="statement-end-if-in-editor" /> Facebook
