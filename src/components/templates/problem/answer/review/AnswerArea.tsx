...
export const AnswerArea: FC<Props> = memo(
  ({ answerSentences, answerId, grammarlyClientId }) => {
              ...
              <Fragment key={sentence.num}>
                    ...
                    >
                      {correctedSentences.find((s) => s.num === sentence.num)
                        ...
                        <Diff
                          ...
                          string2={
                            correctedSentences.find(
                              (s) => s.num === sentence.num,
                            )?.sentence || ''
                          }
                          mode="words"
                        />
                ...
                >
                  <FormControl variant="standard" fullWidth sx={{ mb: 2 }}>
                    <GrammarlyEditorPlugin clientId={grammarlyClientId}>
                      <OutlinedInput
